...
public class CommonMethods extends PageInitiliazer {
		...
		public static void employeeNameDisplayed() {
			Boolean nameDisplayed = driver.findElement(By.xpath("//div[@id=\"profile-pic\"]/h1")).isDisplayed();
			System.out.println("Employee name is displayed? " + nameDisplayed);
		}
